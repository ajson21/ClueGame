...
/**
 * Main driver for clue game. Has board, control panel, and card panel JPanels
 * in one main JFrame
 * 
 * 
...
public class clueGame {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "You are Miss Scarlett. Press Next Player to begin game.",
